...
function removeUnusedNodes(xmlDom)
 ...
 do 
  ...
  set unUsedClassNodes = getUnusedClassNodes(allPropertyNodes, allClassNodes)
  'debug
...
function getUnusedClassNodes(allPropertyNodes, allClassNodes)
 dim unusedClassNodes
 set unusedClassNodes = CreateObject("Scripting.Dictionary")
 'first get the used class nodes
 dim usedClassNodes
 set usedClassNodes = getUsedClassNodes(allPropertyNodes, allClassNodes)
...
function getUsedClassNodes(allPropertyNodes, allClassNodes)
 dim usedClassNodes
