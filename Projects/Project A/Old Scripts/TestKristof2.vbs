...
sub OnProjectBrowserElementScript()
	...
	if eStereoType = "REP_Report" then
		'create output tab
...
sub GenerateFD(selectedElement)
	...
	addModelDocument masterDocument, "REP_Report",documentName, selectedElement.ElementGUID, i	
	i = i + 1
	...
	for each report in reports
		addModelDocument masterDocument, "BI-REP",documentName, report.ElementGUID, i	
		i = i + 1
	next
