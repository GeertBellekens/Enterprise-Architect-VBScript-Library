...
'
' Script Name: Add Associations to Schema
' Author: Geert Bellekens
' Purpose: Reads the selected schema, and adds all associations for which both end are in the schema
' Date: 2019-01-03
'
const outPutName = "Add Associations"
...
'	writefile "c:\\temp\\schemaContents.xml", xmlDom.xml
	addAssociatonsInProfile xmlDom
'	'debug
'	writefile "c:\\temp\\schemaContents_cleaned.xml", xmlDom.xml
	...
	'set timestamp
	Repository.WriteOutput outPutName, now() & " Finished Adding associations", artifact.ElementID
end function
