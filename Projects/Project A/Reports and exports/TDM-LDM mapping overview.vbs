...
const TDMPackageGUID = "{BA787F2C-3E47-43b5-9A4A-280D5199FB30}" 'TDM CMS
'const TDMPackageGUID = "{6A365E1C-CC8D-49a1-B455-C1614F16A8B2}" 'MIRDIR -> TEST
const LDMPackageGUID = "{0C10A9E8-3B77-42f2-B989-E4FA1F97F5F9}" 'LDM CMS
'const LDMPackageGUID = "{507ADB02-76A2-4ac4-A60B-633BE388CD45}" 'Message & Transaction -> TEST
...
'	searchOutput.Show
	...
	dim outputSheet
	set outputSheet = excelOutput.createTab("Mapping details", excelContents, true, "TableStyleMedium15")
	Repository.WriteOutput outputTabName, now() & " Formatting Excel sheet" ,0
	'format the output
	formatOutput excelOutput, outputSheet
...
function formatOutput(excelOutput, outputSheet)
