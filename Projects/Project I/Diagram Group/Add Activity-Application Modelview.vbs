...
'
' Script Name: Add Activity-Application Modelview
' Author: Geert Bellekens
' Purpose: Add a modelview for the relations between the Activities and the Applications of this business process
' Date: 2025-03-12
'

const outPutName = "Add Activity-Application ModelView"
'
...
function addActivityApplicationModelView(currentDiagram)
	...
	if not bp is nothing then
		...
		set modelView = bp.Elements.AddNew("Activity-Application Matrix", "EAUML::ModelView")
		modelView.Update
